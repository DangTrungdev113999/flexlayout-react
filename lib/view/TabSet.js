...
const TabSet = (props) => {
    ...
    tabStrip = (React.createElement("div", { className: tabStripClasses, style: tabStripStyle, 
        // data-layout-path={path + "/tabstrip"}
        onMouseDown: onMouseDown, onTouchStart: onMouseDown, onContextMenu: onContextMenu, onClick: onAuxMouseClick, onAuxClick: onAuxMouseClick },
